...
const translations = {
  de: {
    ...
    login: {
      ...
      heroCopy: 'Ein ruhiger Einstieg für Admins, Redaktion und Operations.',
      ...
      resetHint: 'Fordere einen Reset an oder bestätige einen vorhandenen Reset-Token.',
      username: 'Username',
      password: 'Password',
    ...
    contentHub: {
      ...
      noTasks: 'Keine Tasks.',
      checklistStatus: 'Planungsstatus',
      openTasks: 'offene Tasks',
      requiredOpenTasks: 'offene Pflicht-Tasks',
      notReady: 'Nicht bereit',
      applyTemplate: 'Vorlage anwenden',
      noMatchingTemplates: 'Keine passende Vorlage.',
      platformFields: 'Plattformfelder',
      selectOption: 'Auswahl',
      saving: 'Speichert...',
      tagsPlaceholder: 'tag-1, tag-2, tag-3',
      editTemplate: 'Vorlage bearbeiten',
      newTemplate: 'Neue Vorlage',
      templateSteps: 'Checklisten-Schritte',
      step: 'Schritt',
      steps: 'Schritte',
      addStep: '+ Schritt',
      remove: 'Entfernen',
      editPlatformProfile: 'Plattformprofil bearbeiten',
      createPlatformProfile: 'Plattformprofil erstellen',
      newProfile: 'Neues Profil',
      requiredBaseFields: 'Pflicht-Basisfelder',
      ...
      fields: {
        ...
        tags: 'Tags',
        plannedDate: 'Planungsdatum',
        publishDate: 'Release-Datum',
      ...
      taskFields: {
        ...
        priority: 'Prioritaet',
        dueDate: 'Faelligkeit',
        required: 'Pflicht fuer Publish',
        blocksPublish: 'Blockiert Publish',
        notes: 'Notizen',
        status: 'Status',
      },
      templateFields: {
        ...
        description: 'Beschreibung',
        phase: 'Phase',
        dueOffset: 'Tage relativ zum Release',
      },
      profileFields: {
        name: 'Name',
        platform: 'Plattform',
    ...
    settings: {
      ...
      profile: 'Profil',
      missingRequired: 'Fehlende Pflichtfelder (AI-Generierung blockiert)',
      fallback: 'Fallback',
  ...
  en: {
    ...
    contentHub: {
      ...
      noTasks: 'No tasks.',
      checklistStatus: 'Planning status',
      openTasks: 'open tasks',
      requiredOpenTasks: 'required open tasks',
      notReady: 'Not ready',
      applyTemplate: 'Apply template',
      noMatchingTemplates: 'No matching template.',
      ...
      templateSteps: 'Checklist steps',
      step: 'Step',
      steps: 'steps',
      addStep: '+ Step',
      remove: 'Remove',
      editPlatformProfile: 'Edit platform profile',
      createPlatformProfile: 'Create platform profile',
      newProfile: 'New profile',
      requiredBaseFields: 'Required base fields',
      ...
      templateFields: {
        ...
        description: 'Description',
        phase: 'Phase',
        dueOffset: 'Days relative to release',
      },
      profileFields: {
        name: 'Name',
        platform: 'Platform',
    ...
    settings: {
      ...
      profile: 'Profile',
      missingRequired: 'Missing required fields (AI generation blocked)',
      fallback: 'Fallback',
